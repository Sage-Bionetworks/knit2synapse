...
#' @param parentId A synapse Project or Folder entity object which will be the parent of this file entity 
#' @param entityName User supplied name of the file entity
